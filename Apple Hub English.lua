...
function Notif.New(text, timee)
    ...
    image_button.Image = "rbxassetid://16387473169"
...
ImageButton1.Image = "rbxassetid://16387473169"
...
if game:GetService("CoreGui"):FindFirstChild("RoTemiumHub") then
    game:GetService("CoreGui"):FindFirstChild("RoTemiumHubHub"):Destroy()
end
...
function Update:Window(text,logo,keybind)
    ...
    Ping.Text = "Blox Fruit |  Gamer144 Ác quỷ:)
  ...
  --  UserImage.BackgroundColor3 = Color3.fromRGB(225, 225, 225)
	...
	Logo.Image = "rbxassetid://16400675723"
    ...
    function uitab:AddTab(text,img)
        ...
        IDK.Image = "rbxassetid://" .. tostring(16400689540)
    ...
    function main:AddToggle(TogInfo ,default, callback)
        ...
        ImageButton.Image = "rbxassetid://16400689540"
        ImageButton.ImageColor3 = Color3.fromRGB(255, 255, 255)
    ...
    function main:AddDropdown(text,option,callback)
        ...
        DropImage.Image = "rbxassetid://16400689540"
        ...
        function dropfunc:Clear()
            DropTitle.Text = tostring(Phonk Hub).." : "
            isdropping = false
            Dropdown:TweenSize(UDim2.new(0,385,0,31),"Out","Quad",0.3,true)
            TweenService:Create(
                DropImage,
...
local Library = Update:Window("Phonk Hub","",Enum.KeyCode.RightControl);

local NguyenTien = Library:AddTab("Information","4483345998")
local Main = Library:AddTab("Main","16400675723")
local M = Library:AddTab("Item","16400675723")
local Ss = Library:AddTab("Stats","16400675723")
local RaceV4 = Library:AddTab("Race V4","16400675723")
local P = Library:AddTab("PVP","16400675723")
local R = Library:AddTab("Dungeon","16400675723")
local T = Library:AddTab("Teleport","16400675723")
local S = Library:AddTab("Shop","16400675723")
local D = Library:AddTab("Devil Fruit","16400675723")
local Misc = Library:AddTab("Misc","16400675723")
--- ThÃ´ng Tin
NguyenTien:AddSeperator("Information Developer")
NguyenTien:AddLabel("Owner: Gamer144 skid 60% apple hub:)")
NguyenTien:AddLabel("Support Hub:Nguyễn Thế Bảo")
NguyenTien:AddLabel("Ui: Thunderz Hub")
NguyenTien:AddLabel("I am Script skid:)")

NguyenTien:AddSeperator("Social Network")
NguyenTien:AddButton("Discord Sever By Tiến",function()
setclipboard("https://discord.gg/Dg5nr8CrVV")
Notif.New("Copying To Clipboard DoneðŸŽ‰", 3)
end)
NguyenTien:AddButton("YouTube Tiến Official",function()
setclipboard("https://youtube.com/@imtienguyenz")
Notif.New("Copying To Clipboard DoneðŸŽ‰", 3)
end)
NguyenTien:AddButton("Facebook Official Tiến",function()
